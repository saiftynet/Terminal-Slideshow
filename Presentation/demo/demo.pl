...
sub logo{
   ...
   printAt(12,80, paint("Introducing Term::Graille", "white on_black"));
   printAt(14,80, paint(["Inspired by Drawille by",
...
sub turtle{
   ...
   $canvas->{title}="Turtle";
   printAt(12,80, paint("Turtle Graphics          ", "white on_black"));
   printAt(14,80, paint(["This early version supports ",
                                          "Turtle-like drawing as well e.g.",
                                          "fd,bk,lt,rt,pu,pd,ce,sp "," "x30,], "yellow"));
   printAt(19,80, paint(["\$canvas->logo('fd 35;lt 75')",
                                          "   for (0..23);               ",  
...
sub cube{
   ...
   printAt(12,80, paint("Animated drawings              ", "white on_black"));
   printAt(14,80, paint(["Rotating cube.  This algorithm ",
...
sub lines{
   ...
   printAt(12,80,  paint("Drawing Primitives    ", "white on_black"));
   printAt(14,80,  paint("Lines                         ","yellow"));
   printAt(15,80,  paint(["\$canvas->line(10,10,         ",
                                          "               30,30)        "],"green"));
   printAt(17,80, paint("Curves                       ","yellow"));
   printAt(18,80, paint(["\$canvas->quad_bezier(10,10, ",
                                          "               30,30,50,10); "],"green"));
   printAt(20,80, paint("Circles                    ","yellow"));
   printAt(21,80, paint("\$canvas->circle(30,30,5); ", "green"));
...
sub  waves{	  
   ...
   $canvas->{title}="Waves";	  
   printAt(12,80, paint("Charting/graphing        ", "white on_black"));
   printAt(14,80, paint(["This example plots a line     ",
                                          "on the left most two pixels   ",
                                          "and then scrolls the frame left   ",
                                          "by 2 pixels. e.g :-         ",
                                          " "x30], "yellow"));
   printAt(19,80, paint(["foreach my \$c (1..1000){     ",
