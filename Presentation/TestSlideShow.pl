...
[2,25]
=LIST
["Name: Saif Ahmed","Day Job:Surgeon","Location: UK","Perl CV: Grants Sec","CPAN ID: SAIFTYNET","History: GUIDeFATE, Graille"]
[32,$topRow]
...
"Contents"
=LIST:
["Background","Initial Motivation","Distraction","Current Status","Future","Conclusion"]
[15,$topRow],
<slide-from-right>	
...
"ASCIIloscope"
=LIST:
["Realtime Data Acquisition","Interactivity","Variable sample rate","Auto scaling","Data Analysis","From a Terminal"]
[15,$topRow]
<slide-from-right>

=SLIDE:
=App:
Asciiloscope/asciiloscope.pl

=SLIDE:
=TITLE:"Extending Terminal Graphics"
=LIST:
["Sub-Character plotting","Drawille (asciimoo) ","Term::Drawille (hoelzro)","<green bold>Term::Graille"],
[15,$canvas->{height}/4-3]
<appear>

=SLIDE:
=TITLE:
"Braille and Quarter Block");
=LIST:
["Braille: -", "* 2x4 dots","* Logical", "* Gaps"]
[15,$canvas->{height}/4-3],
"appear",
=SLEEP:
=LIST:
["Quarter Block: -", "* 2x2 blocks","* Arbitrary", "* No Gaps"]
[70,$canvas->{height}/4-3],
"appear",

=SLIDE:
=TITLE:""Term::Graille"
=LIST:
["Heterogenic Drawing","Canvas ","Multiple primtives","Scriptable","Extensions"],
[15,$canvas->{height}/4-3],
"appear",
...
=SLIDE:
=TITLE:""Destructive Distractions"
=LIST:
["Graphical ToolKit","Test applications needed","* Control","* Visualsation","* Responsiveness","Best way?...make Games"],
					[15,$canvas->{height}/4-3],
					"slide from right",
					);

=SLIDE:
=TITLE:""Fun as a Motivator");
			  drawImageContent("zxspectrum.grl",[2,25]
=LIST:
["* Simple Games","* Many Genres","* Responsive","* Capable","* Feature Rich"],
					[60,$canvas->{height}/4-3],
					"slide from right",
					);
		},
...
=TITLE:""Philosophy"
=LIST:
["Minimal outside dependencies","Pure Perl","Develop an SDK","Evolutionary","Genre Engines"],
					[15,$canvas->{height}/4-3],
					"appear",
					);
		},		
...
"Text"
=LIST:
["Large repository of 8X8 Fonts","DGriffin Typography "],
					[15,$canvas->{height}/4-3],
					"appear",
					);
...
"Images"
=LIST:
["* Pixel Plotter","* Import/Export","* Blitting/Blanking","* Pixel Editting"  ]
[15,$canvas->{height}/4-3]
					"appear",
					);
		},		
...
"Animations"
			  drawImageContent("zxspectrum.grl",[2,25]);
=LIST:
["* Low res","* Low speed","* Low memory","* Ideal " ]
[60,$canvas->{height}/4-3]
"appear",
...
=TITLE:"Sprites"
=LIST:
["* Motion","* Collision","* Animation","* Destruction" ]
[60,$canvas->{height}/4-3]
"appear",
...
=TITLE:"Audio"
=LIST:
["* External player","* Synthesis","* Sample","* Speech" ]
[60,$canvas->{height}/4-3]
"appear",
				
				
=SLIDE:
=TITLE:"Term::Graille::Interact")
=LIST:
["uses Term::ReadKey","Maps keys to actions","* Term::Graille::Menu","* Term::Graille::Dialog","* Term::Graille::Textarea" ]
[15,$canvas->{height}/4-3]
"slide from right"
